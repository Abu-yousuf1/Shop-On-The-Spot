...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p  class="lh-base" ><h3>${product.title}</h3>
      Category: ${product.category}<br>
     Rating Count:${product.rating.count}
      <br>Rating:${product.rating.rate} <i class="fas fa-star-half-alt text-warning"></i><i class="fas fa-star-half-alt text-warning"></i><i class="fas fa-star-half-alt text-warning"></i>
    
      <h2>Price: $ ${product.price}</h2></p>
